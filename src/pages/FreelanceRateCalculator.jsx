    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 space-y-6 sm:space-y-8">
        ...
        <div className="text-center space-y-3 sm:space-y-4">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center sm:text-left">
              Smart Freelance Rate Calculator
            </h1>
          </div>
        ...
        <div className="flex justify-center">
          <div className="bg-gray-100 p-1 rounded-lg w-full max-w-md">
            <button
              onClick={() => setActiveTab('hourly')}
              className={`w-1/2 px-3 sm:px-6 py-2 rounded-md font-medium transition-colors text-sm sm:text-base ${
                activeTab === 'hourly' 
            ...
            >
              ...
              <span className="hidden sm:inline">Project Quote</span>
        ...
        {activeTab === 'hourly' && (
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 flex items-center space-x-2 mb-4 sm:mb-6">
              ...
              {!results ? (
                <div className="text-center py-8 sm:py-12">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base px-4">Fill out the form to see your recommended rates</p>
                </div>
              ) : (
                <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xl sm:text-2xl font-bold text-blue-900">${results.hourlyRate}/hour</p>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xl sm:text-2xl font-bold text-green-900">${results.minProjectRate}</p>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xl sm:text-2xl font-bold text-purple-900">${results.avgProjectRate}</p>
                        </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 text-sm sm:text-base"
                  >
                    {copied ? (
                      <>
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-3 space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          <input
                            ...
                            placeholder="Hours"
                            className="w-full sm:w-20 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                            disabled={!results}
                          />
                          <input
                            type="text"
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
              ...
              {!results ? (
                <div className="text-center py-8 sm:py-12">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base px-4">Set your hourly rates first to generate project quotes</p>
                </div>
              ) : !projectResults ? (
                <div className="text-center py-8 sm:py-12">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base">Calculating your project quote...</p>
                </div>
              ) : (
                <div className="space-y-4 sm:space-y-6">
                  {/* Total Cost */}
                  <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4 sm:p-6 text-center">
                    <p className="text-sm font-medium text-purple-700 mb-2">Total Project Cost</p>
                    <p className="text-3xl sm:text-4xl font-bold text-purple-900">${projectResults.totalCost.toLocaleString()}</p>
                      ...
                      {projectResults.milestones.map((milestone, index) => (
                        <div key={index} className="bg-gray-50 rounded-lg p-3 sm:p-4">
                          <div className="flex items-start justify-between mb-2">
                            <h4 className="font-medium text-gray-900 text-sm sm:text-base pr-2">{milestone.name}</h4>
                            <span className="text-base sm:text-lg font-semibold text-gray-900 flex-shrink-0">
                              ${Math.ceil(milestone.cost).toLocaleString()}
                            </span>
                          </div>
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-600 gap-1 sm:gap-0">
                            <span className="break-words">{milestone.description}</span>
                            <span className="flex-shrink-0">{milestone.hours}h ({milestone.percentage.toFixed(0)}%)</span>
                          </div>
                  ...
                  <button
                    ...
                    className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 text-sm sm:text-base"
                  >
                    {copied ? (
                      <>
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">💡 Pro Tips for Freelancers</h3>
